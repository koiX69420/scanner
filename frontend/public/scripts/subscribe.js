...
if (window.location.pathname === "/subscribe" && new URLSearchParams(window.location.search).has("tgId")) {
updateStatus("🔹 Starting wallet subscription...")
    ...
    async function verifyWallet() {
        ...
        if (validationData.success) {
            ...
            return showSuccess(`✅ TG User <b>${tgId}</b> is already subscribed with the wallet: <b>${validationData.publicKey}</b> (<b>${validationData.daysLeft}</b> days remaining)`);
